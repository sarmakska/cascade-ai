...
All notable changes to Cascade AI are documented in this file.
...
- Vitest test suite with unit tests for auto-router and cascade ordering
...
- Extracted cascade runner (`lib/providers/cascade.ts`) from monolithic route
...
### Added
- Multi-provider cascade architecture across Groq, SambaNova, Cerebras, Google Gemini, OpenRouter, Cloudflare, and Tavily
- 6 specialised modes (Smart, Reasoner, Live, Fast, Coder, Vision) with 7–14 engine cascade depth
